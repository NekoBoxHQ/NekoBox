...
mv nekoray/opt/linux64 nekoray/opt/nekobox
rm -rf nekoray/opt/nekobox/usr
rm nekoray/opt/nekobox/launcher
...
setcap cap_net_admin=ep /opt/nekobox/nekobox_core
